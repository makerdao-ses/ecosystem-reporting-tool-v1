...
## [2.1.5](https://github.com/makerdao-ses/ecosystem-reporting-tool-v1/releases/tag/v2.1.5) - 2025-02-07

### Fixed

- Fixed Mac OS build issue

## [2.1.4](https://github.com/makerdao-ses/ecosystem-reporting-tool-v1/releases/tag/v2.1.4) - 2024-12-09

### Fixed

- Added more no-cache header to teams query
- Updated status comments update section

## [2.1.3](https://github.com/makerdao-ses/ecosystem-reporting-tool-v1/releases/tag/v2.1.3) - 2024-03-22

### Fixed

- Set no-cache req header for api requests
...
- Change budget statements query structure due to API changes
...
- Fix for pushing data to Recognised Delegates

## [2.0.4](https://github.com/makerdao-ses/ecosystem-reporting-tool-v1/releases/tag/v2.0.4) - 2023-07-31

⚠️ Ecosystem Actor users are required to use this latest version in order to see their teams name displayed when logging in.

### Fixed

- Fixed Ecosystem Actor Team display if there's more than one team under management.
